    ...
    <section id="principal">
        <div class="container">
            <div class="content-center princip" >
                ...
                <a href="login.php" class="btn btn-secondary margintop-sm">Ingresar <i class="icon ion-md-arrow-dropright-circle colorDark"></i></a>
            </div>
        </div>
    </section>
  </div>
...
<div class="candy"><a href="producto.php">Click Aqui</a></div>
   ...
   <div class="candy"><a href="producto.php">Click Aqui</a></div>
            ...
            <div class="text-center margintop-sm">
                ...
                <a href="#" class="text-dark"><b>Tenemos lo que necesitas.</b></a>
            </div>
        </div>
    </section>
    ...
    <footer class="bgDark">
        <div class="container">
            ...
            <ul class="list-inline">
                ...
                <li class="list-inline-item footer-menu badge badge-info"><a href="faq.php"><b>FAQ</b></a></li>
